...
- [x] 剧本场景可删除。
- [x] 重新解析场景可用。
- [x] 激活新剧本版本后，下游资产/分镜/视频状态被标记 stale 或提示重生成。
...
- [x] 已有资产不会重复创建。
- [x] 同名同类型资产能复用。
- [x] 服装、姿态、阶段不会被误提为主角色名称。
- [x] 资产与剧本场景或剧本版本存在可追溯关系。
- [x] 提取失败时可查看错误。
- [x] 可重新提取资产。
...
- [x] 可删除或解绑镜头图片。
- [x] 可删除或解绑镜头视频。
- [x] 删除媒体绑定不会默认物理删除对象存储文件。
- [x] 可合成最终视频。
- [x] 合成前检查镜头视频完成状态。
- [x] 可查看 final video。
- [x] 可设置 active final video。
- [x] 可删除非当前 final video。
- [x] 当前 final video 删除需要强确认或先切换版本。
- [x] 可下载 final video。
...
- [x] 新增 API 已写入 OpenAPI。
- [x] 前端 api-client 已同步。
- [x] 前端 types 已同步。
- [x] route consistency check 通过。
- [x] Go tests 通过。
- [x] Web typecheck 通过。
- [x] Web lint 通过。
