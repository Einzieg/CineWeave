...
-- Generated from embedded migrations 000001 through 000070.
...
-- migration 000045_commerce_project_identity.sql sha256:207e9736cb90afaf6f6ce1c77862c293be81159f4c4c27a2824796adf4bfd467
BEGIN;
SET search_path TO public;
...
-- migration 000046_commerce_product_and_script.sql sha256:a48172d5c9837a2eeae3a59df908d8de55052b70aaed6a880a77b5b30a694b5f
BEGIN;
SET search_path TO public;
...
-- migration 000047_commerce_storyboard_contracts.sql sha256:2f46749f6c25d3578318cc367a73b305b680b219f7ef19613a1824ab6c4075fc
BEGIN;
SET search_path TO public;
...
-- migration 000048_commerce_production_checkpoints.sql sha256:190b2d5ab1d176d93e7f82db726d30f44c6a23dea0dbb7bcefa3d7a8988fb073
BEGIN;
SET search_path TO public;
...
-- migration 000049_commerce_prompt_registry.sql sha256:1e5add169a419f5a31fd3e94b3c028e42b1409d26618d3e083d24c415cc29d16
BEGIN;
SET search_path TO public;
...
-- migration 000050_commerce_workflow_v1_seed.sql sha256:3841fcb05952cb9a984c174252800933930f8b163ffb139145aab4087fd76d87
BEGIN;
SET search_path TO public;
...
-- migration 000051_commerce_setup_runs.sql sha256:42a02e6d838d40038673e61a7be8a48b76649b727e6aa61aabae89229440c8ee
BEGIN;
SET search_path TO public;
...
-- migration 000052_commerce_setup_retry_attempts.sql sha256:42fd603b9b6d2b91f0642bd50ee28c46bbdd3566904159da16a7a0ae2460f98a
BEGIN;
SET search_path TO public;
...
-- migration 000053_commerce_storyboard_edit_revisions.sql sha256:6fdaecd64e5d9c7e478c2099061329267741465d980f1a3a6502dcc4cc77c89e
BEGIN;
SET search_path TO public;
...
-- migration 000054_commerce_reference_image_runtime.sql sha256:94d5ef79529d144b8e7d5c0e1809f133f532c77fa95a09aa3fd2e5b5c5e241a7
BEGIN;
...
-- migration 000055_commerce_video_runtime.sql sha256:430d8547524523b10d4f6aa24945070f0471f3d4c23d407ef6ff8f0cadee785d
BEGIN;
SET search_path TO public;
...
-- migration 000056_commerce_timeline_runtime.sql sha256:f48169de0b0364f56cd81766ee3dee14f803e5df6252fec038b02ee63d1e4d95
BEGIN;
SET search_path TO public;
...
-- migration 000057_commerce_script_contracts_and_unit_rebuilds.sql sha256:74107fd73e0f8bf60a9501d4700bff88e7e579d0c3495dcacf2c1134ab1e5290
BEGIN;
SET search_path TO public;
...
-- migration 000058_commerce_timeline_identity_repair.sql sha256:5577d7306bcf70c6bf840c4c10fe601eeac8b528a076a153ab0865120a75fdbe
BEGIN;
SET search_path TO public;
...
-- migration 000059_commerce_unit_generation_revision.sql sha256:389c112c92044660e6502abb77f90f2674b30db031c5e29c85cc914afa5ab915
BEGIN;
SET search_path TO public;
...
-- migration 000060_commerce_multilingual_workflow_v2.sql sha256:bbca5a502b65f677cfbd6c05a65fe77443cb6d1fb5a746a1d84c845ecabbe4aa
BEGIN;
SET search_path TO public;
...
-- migration 000061_commerce_storyboard_segmentation_contracts.sql sha256:ac7a81909d25caccf52eb74479f5b094b03944f0137a544bb6b0dc1e602e5206
BEGIN;
SET search_path TO public;
...
-- migration 000062_project_deletion_runtime.sql sha256:72323168be960632eab012ad7540324738845b87e295617670e28053deedb8d1
BEGIN;
SET search_path TO public;
...
-- migration 000063_commerce_storyboard_creative_prompt_v2.sql sha256:40f2bec41997f193b17594e3a59a8b7df510c2f32e357dfcefcc7e3fd385fba0
BEGIN;
SET search_path TO public;
...
-- migration 000064_commerce_localization_review_policy_v2.sql sha256:f12a06a47d7e13c490bdd840d8548954f1f55bdb75f757804e5c53a810f64213
BEGIN;
SET search_path TO public;
...
-- migration 000065_project_deletion_deferred_constraints.sql sha256:7439d9835d93bc010965d6a87a04dd9532d994568d525062d354a39a0fd548d0
BEGIN;
SET search_path TO public;
...
-- migration 000066_commerce_direct_video_runtime.sql sha256:86913f9545d98edb7a9a99e4e5b0c9691a7488d44e27e7cb84e84e6cd6f04771
BEGIN;
SET search_path TO public;
...
-- migration 000067_commerce_script_derivation.sql sha256:9798d813e87767f62bc6d80d55073b1cfed99bdd7759bd4f9dd15dcfa5e58ca6
BEGIN;
SET search_path TO public;
...
-- migration 000068_agent_image_attachments.sql sha256:a8b2a70ffcfb5264b64978ef6062b171a12d09091b82fbe4bff140f98483f5c5
BEGIN;
SET search_path TO public;
...
-- migration 000069_commerce_script_derivation_prompt_hash.sql sha256:eb188eb0f16d8ca6d12d1ecf21673364f3ffa618318d3868c17c1bd1784ef55e
BEGIN;
...
-- migration 000070_workflow_activity_views.sql sha256:4d40b59dc383399b9182490282e2e70345c0080c259ce593e6a6af70bac9e630
BEGIN;
SET search_path TO public;
