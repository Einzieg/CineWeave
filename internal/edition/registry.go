...
func defaultFeatureDescriptors() []FeatureDescriptor {
	return []FeatureDescriptor{
		...
		commercialFeature(FeatureBillingShadowAccount, []string{"billing.manage"}, "billing account provisioning", "billing-center", true),
		commercialFeature(FeatureBillingBalance, []string{"billing.read"}, "billing balance query", "billing-balance", false),
		...
		commercialFeature(FeatureBillingOrganizationWallet, []string{"billing.manage", "billing.spend"}, "project billing binding and provider create", "project-billing-settings", true),
